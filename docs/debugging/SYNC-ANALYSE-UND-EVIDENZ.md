...
- Der Workflow [GitHub → n8n Synchronisation](../../n8n/499J5QUt4xUoTujR/GitHub%20→%20n8n%20Synchronisation.json) lädt Dateien von GitHub mit Referenz **`main`** (Node `Hole Datei von GitHub`).
